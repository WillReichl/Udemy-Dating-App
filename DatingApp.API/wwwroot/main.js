...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getMessageThread = function (id, receipientId) {
        return this.http.get(this.baseUrl + 'users/' + id + '/messages/thread/' + receipientId);
    };
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.cancelRegisterMethod = function (registerMode) {
...
var ListsComponent = /** @class */ (function () {
    function ListsComponent(userService, authService, route, alertify) {
        this.userService = userService;
        this.authService = authService;
        this.route = route;
        this.alertify = alertify;
...
var MemberEditComponent = /** @class */ (function () {
    function MemberEditComponent(activatedRoute, alertify, userService, authService) {
...
var MemberListComponent = /** @class */ (function () {
    ...
    MemberListComponent.prototype.defaultFilters = function () {
        ...
        this.userService
            ...
            messages.forEach(function (message) {
                if (!message.isRead && message.recipientId === userId) {
                    _this.userService.markAsRead(userId, message.id);
                }
            });
        }))
...
/* harmony import */ var ng2_file_upload__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ng2-file-upload */ "./node_modules/ng2-file-upload/index.js");
    ...
    PhotoEditorComponent.prototype.initializeFileUploader = function () {
        ...
        this.uploader.onSuccessItem = function (item, response, status, headers) {
            if (response) {
                ...
                if (photo.isMain) {
                    _this.displayMainPhoto(photo);
                }
            }
        };
    };
    PhotoEditorComponent.prototype.displayMainPhoto = function (photo) {
...
module.exports = __webpack_require__(/*! C:\learning\udemy\aspnet-core-angular\DatingApp\DatingApp-SPA\src\main.ts */"./src/main.ts");
