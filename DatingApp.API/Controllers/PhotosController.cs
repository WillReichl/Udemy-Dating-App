...
namespace DatingApp.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(
            IDatingRepository datingRepository, IMapper mapper, IOptions<CloudinarySettings> options)
        {
            this._datingRepo = datingRepository;
            this._mapper = mapper;
            this._cloudinaryConfig = options;
        ...
        public async Task<IActionResult> DeletePhoto(int userId, int id)
        {
            ...
            if (photoFromRepo.PublicId != null)
            {
                ...
                var cloudinaryResponse = _cloudinary.Destroy(deletionParams);
